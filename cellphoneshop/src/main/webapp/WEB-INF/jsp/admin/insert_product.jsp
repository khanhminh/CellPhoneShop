		...
		<div class="box-content">
			...
			<form class="form-horizontal" action="insert_product" method="post" enctype="multipart/form-data">
				...
				<fieldset>
					...
					<div class="control-group">					
						...
						<div class="controls">
							<s:textfield cssClass="text-box single-line input-xlarge focused" 
								...
								data-val="true" data-val-required="Vui lòng nhập tổng số lượng"
								data-val-regex="Giá trị không hợp lệ"
								data-val-regex-pattern="^\d{1,10}$" /> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.trongLuong"
								data-val="false" data-val-required="Vui lòng nhập số tháng bảo hành"
								data-val-regex="Giá trị không hợp lệ"
								data-val-regex-pattern="^\d{1,10}$" /> 
					...
					<div class="control-group">				
						<label class="control-label" for="productDetail.doDay">
							Độ dày
						</label>
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.doDay"
								data-val="false" data-val-required=""
								data-val-regex="Giá trị không hợp lệ"
								data-val-regex-pattern="^\d{1,10}$" /> 
							
							<span class="field-validation-valid" 
								data-valmsg-for="productDetail.doDay"
								data-valmsg-replace="true"> 
							</span>
						</div>
					</div>
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.soMauManHinh"
								data-val="false" data-val-required=""/> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.doPhanGiaiManHinh"
								data-val="false" data-val-required=""/> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.chuanManHinh"
								data-val="false" data-val-required=""/> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.kichThuocManHinh"
								data-val="false" data-val-required=""
								data-val-regex="Giá trị không hợp lệ"
								data-val-regex-pattern="^\d{1,10}$" /> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.matDoDiemAnh"
								data-val="false" data-val-required=""/> 
					...
					<div class="control-group">				
						<label class="control-label" for="productDetail.cameraSau">
							Thông tin camera sau (chính)
						</label>
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.cameraSau"
								data-val="false" data-val-required=""/> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.cameraTruoc"
								data-val="false" data-val-required=""/> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.tinhNangCamera"
								data-val="false" data-val-required=""/> 
					...
					<div class="control-group">				
						<label class="control-label" for="productDetail.ram">
							Ram
						</label>
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.ram"
								data-val="false" data-val-required=""/> 
							
							<span class="field-validation-valid"
								data-valmsg-for="productDetail.ram"
								data-valmsg-replace="true"> 
							</span>
						</div>
					</div>
					...
					<div class="control-group">				
						<label class="control-label" for="productDetail.gpu">
							GPU
						</label>
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.gpu"
								data-val="false" data-val-required=""/> 
							
							<span class="field-validation-valid"
								data-valmsg-for="productDetail.gpu"
								data-valmsg-replace="true"> 
							</span>
						</div>
					</div>
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.theNhoNgoai"
								data-val="false" data-val-required=""/> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.dungLuongTheToiDa"
								data-val="false" data-val-required=""
								data-val-regex="Giá trị không hợp lệ"
								data-val-regex-pattern="^\d{1,10}$" /> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.dungLuongPin"
								data-val="false" data-val-required=""
								data-val-regex="Giá trị không hợp lệ"
								data-val-regex-pattern="^\d{1,10}$" /> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.congNghePin"
								data-val="false" data-val-required=""/> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.thoiGianChoToiDa"
								data-val="false" data-val-required=""
								data-val-regex="Giá trị không hợp lệ"
								data-val-regex-pattern="^\d{1,10}$" /> 
					...
					<div class="control-group">				
						<label class="control-label" for="productDetail.thoiGianChoQuayPhim">
							Thời gian chờ quay phim
						</label>
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.thoiGianChoQuayPhim"
								data-val="false" data-val-required=""
								data-val-regex="Giá trị không hợp lệ"
								data-val-regex-pattern="^\d{1,10}$" /> 
					...
					<div class="control-group">				
						<label class="control-label" for="productDetail.thoiGianChoGoiDien">
							Thời gian chờ gọi điện
						</label>
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.thoiGianChoGoiDien"
								data-val="false" data-val-required=""
								data-val-regex="Giá trị không hợp lệ"
								data-val-regex-pattern="^\d{1,10}$" /> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.loaiBanPhim"
								data-val="false" data-val-required=""/> 
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.wifi"
								data-val="false" data-val-required=""/> 
							
							<span class="field-validation-valid" 
								data-valmsg-for="productDetail.wifi"
								data-valmsg-replace="true"> 
							</span>
						</div>
					</div>
					...
					<div class="control-group">				
						...
						<div class="controls">
							<s:textfield class="text-box single-line input-xlarge focused" 
								type="text"
								theme="simple"
								name="productDetail.gprs"
								data-val="false" data-val-required=""/> 
							
							<span class="field-validation-valid" 
								data-valmsg-for="productDetail.gprs"
								data-valmsg-replace="true"> 
							</span>
						</div>
					</div>
