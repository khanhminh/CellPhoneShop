...
public class Thongsosmartphone implements java.io.Serializable {
	...
	public Thongsosmartphone(Loaibanphim loaibanphim, Hedieuhanh hedieuhanh,
			...
			String tinhNangCamera, String quayPhim, Boolean videoCall,
			Float tocDoCpu, Short soNhanCpu, String chipset, String ram,
			String gpu, String boNhoTrong, String theNhoNgoai,
			...
			String denFlash, String denPin, Set ctsanphams) {
