...
public class Thongsodtdd implements java.io.Serializable {
	...
	public Thongsodtdd(Loaibanphim loaibanphim, String loaiManhinh,
			String soMauManHinh, String doPhanGiaiManHinh, String chuanManHinh,
			Float kichThuocManHinh, String camUng, String matDoDiemAnh,
			String cameraSau, String cameraTruoc, String tinhNangCamera,
			String quayPhim, String boNhoTrong, String theNhoNgoai,
			Short dungLuongTheToiDa, Float dungLuongPin, String congNghePin,
			Boolean pinCoTheThaoRoi, Float thoiGianChoToiDa,
			Float thoiGianChoQuayPhim, Float thoiGianChoGoiDien, String mang2g,
			String mang3g, String mang4g, String wifi, String bluetooth,
			String gprs, Short soLuongSim, String gps, String boCamBien,
			String denPin, Set ctsanphams) {
